...
import Settings.Flavours.Development (developmentFlavour)
...
userDefaultFlavour = "debug_rts"

-- | User-defined build flavours. See 'userFlavour' as an example.
userFlavours :: [Flavour]
userFlavours = [userFlavour, debugRtsFlavour] -- Add more build flavours if need be.
...
debugRtsFlavour :: Flavour
debugRtsFlavour = (developmentFlavour Stage2)
    { name = "debug_rts",
      libraryWays = pure [vanilla],
      rtsWays = pure [vanilla, threaded, threadedDebug, debug],
